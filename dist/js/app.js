...
if (typeof jQuery === "undefined") {
  throw new Error("VS requires jQuery");
}
 ...
 * - Implementation -
 * ------------------
 * The next block of code implements VS's
...
$(function () {
  ...
  if (o.sidebarPushMenu) {
    $.VS.pushMenu(o.sidebarToggleSelector);
  }
 ...
 * - VS Functions -
 * ----------------------
 * All VS functions are implemented below.
 */
 ...
 *
 * @type Object
 * @usage $.VS.layout.activate()
 *        $.VS.layout.fix()
 *        $.VS.layout.fixSidebar()
 */
$.VS.layout = {
  activate: function () {
    var _this = this;
  ...
  fixSidebar: function () {
    ...
    if ($.VS.options.sidebarSlimScroll) {
      if (typeof $.fn.slimScroll != 'undefined') {
 ...
 *
 * @type Function
 * @usage: $.VS.pushMenu("[data-toggle='offcanvas']")
 */
$.VS.pushMenu = function (toggleBtn) {
 ...
 *
 * @type Function
 * @Usage: $.VS.tree('.sidebar')
 */
$.VS.tree = function (menu) {
  var _this = this;
 ...
 *
 * @type Object
 * @usage $.VS.boxWidget.activate()
 *        Set all of your option in the main $.VS.options object
 */
$.VS.boxWidget = {
  activate: function () {
    var o = $.VS.options;
  ...
  options: $.VS.options.boxWidgetOptions
};
